...
<div class="row">
    ...
    <div class="col">
        ...
        <div class="view_product_box card card_style" align="center">
            ...
            <table width="80%" align="center">
                ...
                $all_users = mysqli_query($connect, "select * from user order by user_id ASC ");
                        ...
                        try {
                            ...
                            if ($select_stmt->rowCount() > 0) {
                                if ($username == $row["username"]) {
                                    $all_users = mysqli_query($connect, "SELECT * FROM user WHERE username LIKE '%$username%'");
                                }
                ...
                while ($row = mysqli_fetch_array($all_users)) {
                    ...
                    <tr>
                        ...
                        <td><img src="userspp/<?php echo $row['pp']; ?>" class="ppuser"/></td>
                        <td><?php echo $row['name']; ?></td>
                        <td><?php echo $row['lastname']; ?></td>
                        <td><?php echo $row['username']; ?></td>
                        <td><?php echo $row['email']; ?></td>
                        <td>
                            <a href="admin_user.php?action=view_pro&delete_user=<?php echo $row['user_id']; ?>">Delete</a>
                        </td>
    ...
    if (isset($_GET['delete_user'])) {
        $delete_product = mysqli_query($connect, "delete from user where user_id='$_GET[delete_user]' ");
